...
provider "github" {
  # Configuration options
  token = "XXXXXXX"   # Insert your token here !!!
}
...
resource "aws_instance" "tf-docker-ec2" {
  ...
  key_name = "desmond"   # Insert your key name here !!!
  ...
  user_data = <<-EOF
          ...
          FOLDER="https://$TOKEN@raw.githubusercontent.com/alpi1977/bookstore-repo/main/" 
