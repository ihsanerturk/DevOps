...
mkdir bin
cd bin
wget http://54.236.62.225:8080/jnlpJars/agent.jar
```
...
- Enter `ssh -i /var/lib/jenkins/.ssh/id_rsa root@54.236.62.225 java -jar -Djava.io.tmpdir=/mnt /root/bin/agent.jar` in the "Launch command" field.
